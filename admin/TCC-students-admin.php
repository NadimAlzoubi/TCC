                ...
                <ul class="nav_list">
                    ...
                    <li class="nav_item" id="li7">
                        <a href="../TCC-login.php" class="nav_link">
                            ...
                            <span class="nav_name">إدارة المعهد - شؤون الطلاب</span> 
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="navContainer">
        ...
        <div class="navigation">
            ...
            <ul>
                ...
                <li id="li22">
                    <a href="TCC-students-admin.php">
                        <span class="icon"><ion-icon name="person-circle-outline"></ion-icon></span>
                        <span class="title">سجل الطلاب</span>
                    </a>
                </li>
                <!-- <li id="li3">
                    <a href="subjects-register.php">
                        <span class="icon"><ion-icon name="library-outline"></ion-icon></span>
                        <span class="title">سجل المقررات</span>
                    </a>
                </li> -->
                <!-- <li id="li4">
                    <a href="#">
                ...
                <!-- <li id="li5">
                    <a href="exam-register.php">
                        <span class="icon"><ion-icon name="file-tray-stacked-outline"></ion-icon></span>
                        <span class="title">سجل الامتحانات</span>
                    </a>
                </li> -->
                <!-- <li id="li6">
