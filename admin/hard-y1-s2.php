...
<style>
    ...
    <div class="navContainer">
        ...
        <div class="exam_title">
                <span>قسم الحواسيب - السنة الأولى - الفصل الثاني</span>
            </div>
        <div class="mark_main">
                ...
                <div class="fieldset1" style="width: 100%;">
                    ...
                    if (isset($_POST['addproH'])) {
                        ...
                        $total = $_POST['total'];
                        $result = $_POST['result'];
                        $addDataM = $database->prepare("INSERT INTO hy1s2_programming1(stu_id,stu_name,sub_name,business_degree,exam_degree,total,result)
                    ...
                    if (isset($_POST['hy1s2_english2'])) {
                        ...
                        $addDataM = $database->prepare("INSERT INTO hy1s2_english2(stu_id,stu_name,sub_namee,business_degreee,exam_degreee,totale,resulte)
                    ...
                    //دارات متكاملة
                    if (isset($_POST['hy1s2_integrated_circuits'])) {
                        $stu_id = $_POST['stu_id'];
                        $stu_name = $_POST['stu_name'];
                        ...
                        $addDataM = $database->prepare("INSERT INTO hy1s2_integrated_circuits(stu_id,stu_name,sub_namef,business_degreef,exam_degreef,totalf,resultf)
                    ...
                    // بنية حاسوب
                    if (isset($_POST['hy1s2_computerarchitecture'])) {
                        $stu_id = $_POST['stu_id'];
                        $stu_name = $_POST['stu_name'];
                        ...
                        $addDataM = $database->prepare("INSERT INTO hy1s2_computerarchitecture(stu_id,stu_name,sub_namem,business_degreem,exam_degreem,totalm,resultm)
                    ...
                    // صيانة حاسوب 1
                    if (isset($_POST['hy1s2_computermaintenance'])) {
                        $stu_id = $_POST['stu_id'];
                        $stu_name = $_POST['stu_name'];
                        ...
                        $addDataM = $database->prepare("INSERT INTO hy1s2_computermaintenance(stu_id,stu_name,sub_namec,business_degreec,exam_degreec,totalc,resultc)
                    ...
                    // وحدات محيطية
                    if (isset($_POST['hy1s2_peripheralunits'])) {
                        $stu_id = $_POST['stu_id'];
                        $stu_name = $_POST['stu_name'];
                        ...
                        $addDataM = $database->prepare("INSERT INTO hy1s2_peripheralunits(stu_id,stu_name,sub_namel,business_degreel,exam_degreel,totall,resultl)
                    ...
                    if (isset($_POST['dal_hy1s2_programming1'])) {
                        $stu_id = $_POST['stu_id'];
                        $up_viow = $database->prepare("UPDATE _hy1s2_programming1 SET business_degree=0,exam_degree=0,total=0,result='تم التصفير' WHERE stu_id=('$stu_id')");
                        $up_viow->execute();
                    ...
                    if (isset($_POST['del_hy1s2_english2'])) {
                        $stu_id = $_POST['stu_id'];
                        $up_viow = $database->prepare("UPDATE hy1s2_english2 SET business_degreee=0,exam_degreee=0,totale=0,resulte='تم التصفير' WHERE stu_id=('$stu_id')");
                        $up_viow->execute();
                        if ($up_viow->execute() === true) {
                            echo "<script>alert('تم تصفير المادة ')</script>";
                            echo "<script>document.location='http://localhost/tcc-project/admin/exam-admin/soft-y1-s1.php'</script>";
                    ...
                    if (isset($_POST['del_hy1s2_integrated_circuits'])) {
                        $stu_id = $_POST['stu_id'];
                        $up_viow = $database->prepare("UPDATE hy1s2_integrated_circuits SET business_degreef=0,exam_degreef=0,totalf=0,resultf='تم التصفير' WHERE stu_id=('$stu_id')");
                        $up_viow->execute();
                        if ($up_viow->execute() === true) {
                            echo "<script>alert('تم تصفير المادة ')</script>";
                            echo "<script>document.location='http://localhost/tcc-project/admin/exam-admin/soft-y1-s1.php'</script>";
                    ...
                    if (isset($_POST['del_hy1s2_computerarchitecture'])) {
                        $stu_id = $_POST['stu_id'];
                        $up_viow = $database->prepare("UPDATE hy1s2_computerarchitecture SET business_degreem=0,exam_degreem=0,totalm=0,resultm='تم التصفير' WHERE stu_id=('$stu_id')");
                        $up_viow->execute();
                        if ($up_viow->execute() === true) {
                            echo "<script>alert('تم تصفير المادة ')</script>";
                            echo "<script>document.location='http://localhost/tcc-project/admin/exam-admin/soft-y1-s1.php'</script>";
                    ...
                    if (isset($_POST['del_hy1s2_computermaintenance'])) {
                        $stu_id = $_POST['stu_id'];
                        $up_viow = $database->prepare("UPDATE hy1s2_computermaintenance SET business_degreec=0,exam_degreec=0,totalc=0,resultc='تم التصفير' WHERE stu_id=('$stu_id')");
                        $up_viow->execute();
                        if ($up_viow->execute() === true) {
                            echo "<script>alert('تم تصفير المادة ')</script>";
                            echo "<script>document.location='http://localhost/tcc-project/admin/exam-admin/soft-y1-s1.php'</script>";
                    ...
                    if (isset($_POST['del_peripheralunits'])) {
                        $stu_id = $_POST['stu_id'];
                        $up_viow = $database->prepare("UPDATE hy1s2_peripheralunits SET business_degreel=0,exam_degreel=0,totall=0,resultl='تم التصفير' WHERE stu_id=('$stu_id')");
                        $up_viow->execute();
                        if ($up_viow->execute() === true) {
                            echo "<script>alert('تم تصفير المادة ')</script>";
                            echo "<script>document.location='http://localhost/tcc-project/admin/exam-admin/soft-y1-s1.php'</script>";
                    ...
                    if (isset($_POST['del_culture'])) {
                        $stu_id = $_POST['stu_id'];
                        $up_viow = $database->prepare("UPDATE addc2_culture SET business_degree=0,exam_degree=0,total=0,resulta='تم التصفير' WHERE stu_id=('$stu_id')");
                        $up_viow->execute();
                        if ($up_viow->execute() === true) {
                            echo "<script>alert('تم تصفير المادة ')</script>";
                            echo "<script>document.location='http://localhost/tcc-project/admin/exam-admin/soft-y1-s1.php'</script>";
                    ...
                    <form method='POST'>
                        ...
                        <div class="indiv">
                            ...
                            <input type="text" name="sub_name" value=" برمجة 1" class="form-control" style="padding-left: 0px; background: none; width: 125px;">
                            ...
                            <input type="submit" id="" name="dal_hy1s2_programming1" value="تصفير المادة" class="btn btn-dark" style="position: relative; right: 20px; width: 125px;">
                        </div>
                        <div class="indiv" style="font-weight: bolder;">
                            <!-- <label for="">لـــغــة أجــنــبــيــــة 2</label> -->
                            <input type="text" name="sub_namee" value="2لغة اجنبية" class="form-control" style="padding-left: 0px; background: none; width: 125px;">
                            ...
                            <input type="submit" id="" name="hy1s2_english2" value=" حــفــظ " class="btn btn-primary" style="position: relative; right: 20px; width: 125px;">
                            <input type="submit" id="" name="del_hy1s2_english2" value="تصفير المادة" class="btn btn-dark" style="position: relative; right: 20px; width: 125px;">
                        </div>

                        <!-- =============================================== -->
                        
                        <div class="indiv">
                            <!-- <label for="" style="font-weight: bolder;"> دارات متكاملة </label> -->
                            <input type="text" name="sub_namef" value="دارات متكاملة " class="form-control" style="padding-left: 0px; background: none; width: 125px;">
                            ...
                            <input type="submit" id="" name="hy1s2_integrated_circuits" value=" حــفــظ " class="btn btn-primary" style="position: relative; right: 20px; width: 125px;">
                            <button type="submit" class="btn btn-danger" name="del_hy1s2_integrated_circuits" style="position: relative; right: 20px; width: 125px;">تصفير المادة</button>
                        </div>
                        <div class="indiv">
                            <!-- <label for="" style="font-weight: bolder;"> بنية حاسوب 1 </label> -->
                            <input type="text" name="sub_namem" value="بنية حاسوب 1 " class="form-control" style="padding-left: 0px; background: none; width: 125px;">
                            ...
                            <input type="submit" id="" name="hy1s2_computerarchitecture" value=" حــفــظ " class="btn btn-primary" style="position: relative; right: 20px; width: 125px;">
                            <input type="submit" id="" name="del_hy1s2_computerarchitecture" value="تصفير المادة" class="btn btn-dark" style="position: relative; right: 20px; width: 125px;">
                        </div>
                        <div class="indiv" style="font-weight: bolder;">
                            <!-- <label for=""> صيانة حاسوب 1 </label> -->
                            <input type="text" name="sub_namec" value=" صيانة حاسوب 1 " class="form-control" style="padding-left: 0px; background: none; width: 125px;">
                            ...
                            <input type="submit" id="" name="hy1s2_computermaintenance" value=" حــفــظ " class="btn btn-primary" style="position: relative; right: 20px; width: 125px;">
                            <input type="submit" id="" name="del_hy1s2_computermaintenance" value="تصفير المادة" class="btn btn-danger" style="position: relative; right: 20px; width: 125px;">
                        </div>
                        <div class="indiv" style="font-weight: bolder;">
                            <!-- <label for=""> وحدات محيطية  </label> -->
                            <input type="text" name="sub_namel" value="وحدات محيطية" class="form-control" style="padding-left: 0px; background: none; width: 125px;">
                            ...
                            <input type="text" id="inr" name="resultl" placeholder="النـتـيـجـة" class="form-control" style="margin-right: 10px; width:125px;">
                            <input type="submit" id="" name="hy1s2_peripheralunits" value=" حــفــظ " class="btn btn-primary" style="position: relative; right: 20px; width: 125px;">
                            <input type="submit" id="" name="del_peripheralunits" value="تصفير المادة" class="btn btn-danger" style="position: relative; right: 20px; width: 125px;">
                        </div>
                        <div class="indiv">
                            <!-- <label for="" style="font-weight: bolder;">ثقافة </label> -->
                            <input type="text" name="sub_namec" value="ثقافة" class="form-control" style="padding-left: 0px; background: none; width: 125px;">
                            <input type="number" id="ar1" name="business_degreec" placeholder="درجة الاعمال" class="form-control" style="margin-right: 10px; width: 125px;">
                            <input type="text" id="ar2" name="exam_degreec" placeholder="درجة الامتحان" style="margin-right: 10px; text-align:center; width:125px" class="form-control">
                            <input type="text" id="ar3" name="totalc" placeholder="الـمـجـمـوع" class="form-control" style="margin-right: 10px; width: 125px;">
                            <input type="text" id="ar4" oninput="sumar()" name="resultc" placeholder="النـتـيـجـة" style="margin-right: 10px; width: 125px;" class="form-control">
                            <input type="submit" id="" name="addc2_culture" value="حــفـظ" class="btn btn-primary" style="position: relative; right: 20px; width: 125px;" class="form-control">
                            <input type="submit" id="" name="del_culture" value="تصفير المادة" class="btn btn-danger" style="position: relative; right: 20px; width: 125px;">
                        </div>
                    </form>
                </div>
            </div>
