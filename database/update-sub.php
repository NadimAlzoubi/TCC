...
<body>
    ...
    <?php
                ...
                if(isset($_POST['up_nam'])){             
                    $delid2 = $_POST['del2'];
                    $sql_s = "SELECT * FROM subjects WHERE ID = '$delid2'";
...
?>                        
    ...
    <form method="POST" id="form12">
        ...
        <label>أدخل رابط التحميل الجديد</label>
        <input type="text" name="link" value="<?php echo $row['LINK']; ?>" style="height: auto;">
    ...
    if(isset($up_tech)) {
        $delid6 = $_POST['del6'];
        $sql_u = "UPDATE subjects SET NAME = '$up_name1', LINK = '$up_link' WHERE ID = '$delid6'";
